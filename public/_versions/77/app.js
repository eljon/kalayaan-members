(() => {
  ...
  // report period, the comparison period, and the change (raw count and
  // percentage-point difference of roster share). Everything reconciles:
  // Δ# = report# − compare#, and Δ% = report% − compare%.
  function compareTable(rows) {
    ...
    for (const r of rows) {
      ...
      const dPct = (r.rPct != null && r.cPct != null) ? r.rPct - r.cPct : null;

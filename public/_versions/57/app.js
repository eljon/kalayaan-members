(() => {
  ...
  function crInit() {
    ...
    crState = { groupsMatch: "all", groups: [{ match: "all", filters: [] }], columns: defaults, description: "" };
    crReady = true;
  }
  ...
  function crSaveCurrent() {
    ...
    saved[name] = { groupsMatch: crState.groupsMatch, groups: crState.groups, columns: crState.columns, description: crState.description || "" };

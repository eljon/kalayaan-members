(() => {
  ...
  function printReport() {
    const names = { attendance: "Attendance", returned: "Returned Missionaries", members: "Members", custom: "Custom Reports", actions: "Action Lists" };
  ...
  ["att-pdf", "rm-pdf", "mem-pdf", "cr-pdf", "al-pdf"].forEach((id) => {
    const btn = $(id);
  ...
  ["att-sheet", "rm-sheet", "mem-sheet", "cr-sheet", "al-sheet"].forEach((id) => {
    const btn = $(id);

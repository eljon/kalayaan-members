(() => {
  ...
  function renderReturned() {
    ...
    $("rm-count").textContent = countText(rows.length, total, "people");
  ...
  function renderMembers() {
    ...
    $("mem-count").textContent = countText(rows.length, total, "people", `${cols.length} fields`);
  ...
  function renderCrTable() {
    ...
    const total = (members.records || []).length;
    $("cr-count").textContent = countText(rows.length, total, "members", `${cols.length} columns`);

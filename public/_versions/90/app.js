(() => {
  ...
  function alNewState() {
    return { groupsMatch: "all", groups: [{ match: "all", filters: [] }], columns: crDefaultColumns(), columnsCustomized: false };
  }
  function alAllLists() {
  ...
  function renderActions() {
    ...
    if (!entry) { $("al-table").innerHTML = ""; $("al-count").textContent = ""; $("al-summary").textContent = ""; return; }
  ...
  function serializeCurrentReport() {
    ...
    if (activeTab === "actions") {
      const entry = alActiveEntry();
      // The Done column comes through as empty cells on purpose — a printed
      // or exported action list wants a box to tick against each name.
